...
public class StudentScholarListener extends StudentAvgCounter implements EventListener {

    private final CursesController coursesController;
    public StudentScholarListener(Set<Course> courses, StudentsService studentsService, StudentsController studentsController,  CursesController coursesController) {
    ...
    public void update(Object o) {
        if(o instanceof Student) {
            ...
            if(avg >= 4.5) {
                studentsService.updateStudentByID(student.getID(), "Wybitny");
